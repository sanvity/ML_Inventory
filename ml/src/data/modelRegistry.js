...
export const MODELS = {
  ...
  sarima: {
    id: 'sarima',
    backendKey: 'sarima_time',
    category: 'timeseries',
    name: 'SARIMA',
    description: 'An extension of ARIMA that supports univariate series with a repeating seasonal cycle.',
    badge: 'Seasonal',
    badgeVariant: 'warning',
    icon: 'calendar-stats',
    goalTypes: ['forecasting'],
    goodFor: ['Time series with regular repeating patterns', 'Univariate forecasting'],
    pros: ['Captures seasonal peaks and troughs', 'Statistical forecast intervals built in'],
    cons: ['Manual seasonal lag parameter tuning', 'No exogenous variable support'],
    dataRequirements: '60+ time steps with clear seasonal cycles.',
    speed: 'medium',
    difficulty: 'intermediate',
    comparisonNote: 'Best for univariate data with clear recurring seasonality',
  },
  arimax: {
    id: 'arimax',
    backendKey: 'arimax_time',
    category: 'timeseries',
    name: 'ARIMAX',
    description: 'An extension of ARIMA that incorporates external (exogenous) features to improve forecast accuracy.',
    badge: 'Covariates',
    badgeVariant: 'info',
    icon: 'timeline-event',
    goalTypes: ['forecasting'],
    goodFor: ['Time series with strong external causal drivers', 'Predictive lag structures'],
    pros: ['Leverages other columns as leading indicators', 'Combines lag analysis and regressions'],
    cons: ['Requires future values of exogenous inputs to forecast', 'Higher parameter complexity'],
    dataRequirements: '50+ time steps with continuous target and feature vectors.',
    speed: 'medium',
    difficulty: 'advanced',
    comparisonNote: 'Best when external indicators (like marketing budget) influence the forecast',
  },
  prophet: {
    id: 'prophet',
    backendKey: 'prophet',
...
export function getRecommendations(goalId, datasetMeta) {
  ...
  const map = {
    ...
    forecasting: {
      ...
      alternatives: ['arima', 'sarima', 'arimax', 'xgboost_ts', 'lstm'],
    },
    simulation: {
      primary: 'monte_carlo',
